 ...
 * @param listener apointer to a listener instance. Can be 0/NULL.
 ...
 * TRUE, the event is considered handled and is not passed to any more listeners.
...
// System internal event codes. Aplication should use codes beyond 255.
